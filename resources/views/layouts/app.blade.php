...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-dark fixed-top">
        <div class="container-fluid d-flex justify-content-between align-items-center">
            <!-- Left: Brand/Logo -->
            <a class="navbar-brand text-white fw-bold" href="{{ url('/') }}" style="font-size: 24px;">MyWebsite</a>
            ...
            <div class="collapse navbar-collapse justify-content-center ms-5" id="navbarNav">
                <ul class="navbar-nav text-center">
                    <li class="nav-item"><a class="nav-link nav-custom" href="#home">Home</a></li>
                    <li class="nav-item"><a class="nav-link nav-custom" href="#about">About</a></li>
                    <li class="nav-item"><a class="nav-link nav-custom" href="#services">Services</a></li>
                    <li class="nav-item"><a class="nav-link nav-custom" href="#faq">FAQ</a></li>
                    <li class="nav-item dropdown mt-2 fw-bold">
                        <a href="#" class="nav-link dropdown-toggle text-white" id="pricingDropdown"
                            role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            Pricing
                        </a>
                        <ul class="dropdown-menu" aria-labelledby="pricingDropdown">
                            <li><a class="dropdown-item" href="{{route('social_media') }}">Social Media</a></li>
                            <li><a class="dropdown-item" href="{{route('wordpress') }}">Full WordPress</a></li>
                            <li><a class="dropdown-item" href="{{ route('wordpress_speed_optz') }}">WordPress Speed Optimization</a></li>
                            <li><a class="dropdown-item" href="{{ route('fix_wordpress') }}">Fix WordPress Error</a></li>
            ...
            <div class="row align-items-start">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="company-card">
                        ...
                        <p class="company-description">
                            ...
                            customer-centric
                            web & mobile app development services cater to the digital needs of all-scale businesses.
                        </p>
                ...
                <div class="col-lg-5 col-md-12">
                    ...
                    <div class="address-container">
                        ...
                        <p class="address-text mt-5">Know where to find us? Let's take a look and get in touch! We have
                            offices
                        ...
                        <div class="col-md-6 mb-3 mb-md-0">
                            <div class="map-container">
                                ...
                                <div class="hotspot mt-4" style="top: 40%; left: 55%;">
                                    <i class="fas fa-map-marker-alt"></i>
                                    <div class="hotspot-tooltip" style="top: -50px; left: -40px;">Saudi Arabia</div>
                                </div>
                            </div>
                        </div>
